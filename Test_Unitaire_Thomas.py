...
class TestParkingSpec(unittest.TestCase):
    ...
    def test_occuper_place_libre(self):
        # Pré :
        #     - La place self.place2 est libre (plaque = None)
        # Post :
        #     - La place est occupée 
        #     - Le message retourné contient "occupée"

        Parking.occuper_place(self.place2.id, "AA-123-BB") # appel la fonction a tester
    ...
    def test_liberer_place(self):
        # Pré:
        #     - La place self.place1 est occupée 
        # Post :
        ...
        res = Parking.liberer_place(self.place1.id) #appel la fonction a tester 
